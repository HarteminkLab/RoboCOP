...
def runROBOCOP_Viterbi(coordFile, config, outDir, tmpDir, trainOutDir, pool, dnaseFiles = ""):
...
if __name__ == '__main__':
        if len(sys.argv) != 5:
                print("Usage: python robocop_viterbi.py <coordinate file> <config file> <trained output dir> <outputDir>")
                exit(1)
        ...
        runROBOCOP_Viterbi(coordFile, config, outDir, tmpDir, trainOutDir, pool)
